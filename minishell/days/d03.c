...
{
	if (strcmp(str->str[0], "unset") == 0)
	{
		ft_unset(str->str);
		return (1);
	}
	else if (strcmp(str->str[0], "exit") == 0)
	{
		ft_exit(str->str);
		return (1);
	}
	else if (strcmp(str->str[0], "export") == 0)
	{
		ft_export(str->str);
		return (1);
	}
	else if (strcmp(str->str[0], "pwd") == 0 || strcmp(str->str[0], "PWD") == 0)
	{
		ft_pwd();
		return (1);
	}
...
int	check_if_built(t_exeuction *str)
{
	...
	if (!str || !str->str || str->str[0] == NULL)
		return (1);
	if (strcmp(str->str[0], "echo") == 0 || strcmp(str->str[0], "ECHO") == 0)
	{
		ft_echo(str->str);
		return (1);
	}
	else if (strcmp(str->str[0], "cd") == 0)
	{
		ft_cd(str->str);
		return (1);
	}
	else if (strcmp(str->str[0], "env") == 0 || strcmp(str->str[0], "ENV") == 0)
	{
		ft_env();
		return (1);
	}
